...
const PLANS = [
  {
    ...
    features: [
      "Sous-domaine offert (nom.lumina.ga)",
      "Jusqu'à 50 commandes / billets par mois",
      "Génération illimitée de Menus & QR Codes",
      "Paiement au comptoir (cash à la livraison)",
      "Écran cuisine KDS basique",
